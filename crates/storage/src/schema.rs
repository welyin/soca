...
/// 迁移 4：L5 记忆主存与失效传播。
const MIGRATION_0004: &str = include_str!("../migrations/0004_memory.sql");

/// 迁移 5：L6 受托目标栈。
const MIGRATION_0005: &str = include_str!("../migrations/0005_goals.sql");
...
/// 迁移 8：事件的权限范围。
const MIGRATION_0008: &str = include_str!("../migrations/0008_event_capability.sql");
